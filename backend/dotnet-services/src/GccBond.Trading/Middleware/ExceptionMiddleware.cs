...
namespace GccBond.Trading.Middleware;

/// <summary>
/// Catches all unhandled exceptions and converts them to standardised JSON responses.
/// Must be registered before all other middleware in Program.cs.
/// </summary>
